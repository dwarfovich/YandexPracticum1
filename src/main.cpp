...
int main(int argc, char *argv[]) {
    ...
    std::istringstream inStream("01234567890123456789");
    std::ostringstream outStream;
    cryptoCtx.EncryptFile(inStream, outStream, "12341234");

    std::cout << "in: " << inStream.str() << std::endl;
    std::cout << "out: " << outStream.str() << std::endl;
    try {
        //
